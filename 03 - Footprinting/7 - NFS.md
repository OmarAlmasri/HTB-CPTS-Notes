...
```shell
Ripcord88x@htb[/htb]$ cat /etc/exports 
...
```shell
Ripcord88x@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell
Ripcord88x@htb[/htb]$ showmount -e 10.129.14.128
...
```shell
Ripcord88x@htb[/htb]$ mkdir target-NFS
Ripcord88x@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
Ripcord88x@htb[/htb]$ cd target-NFS
Ripcord88x@htb[/htb]$ tree .
